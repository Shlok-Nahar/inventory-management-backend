...
namespace Inventory_Management.Migrations
{
    ...
    [Migration("20241226195731_RedoTransactionLogic")]
    partial class RedoTransactionLogic
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("InventoryManagement.TransactionEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            productID = 1,
                            quantity = 5,
                            transactionDate = new DateTime(2024, 12, 26, 20, 57, 31, 371, DateTimeKind.Local).AddTicks(5206),
