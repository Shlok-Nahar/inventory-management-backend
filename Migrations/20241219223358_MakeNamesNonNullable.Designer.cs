...
namespace Inventory_Management.Migrations
{
    ...
    [Migration("20241219223358_MakeNamesNonNullable")]
    partial class MakeNamesNonNullable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("InventoryManagement.TransactionEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            productID = 1,
                            quantity = 5,
                            transactionDate = new DateTime(2024, 12, 19, 23, 33, 57, 755, DateTimeKind.Local).AddTicks(1582),
